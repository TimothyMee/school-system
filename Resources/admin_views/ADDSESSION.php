<?php
  ...
  if(isset($_POST['add_session'])){
    ...
    $queriesObject->insertSession($session,$semester);
  }
?>
...
<html lang="en">
  <head>
    ...
    <title>McU E-PORTAL-Add Session</title>
  ...
  <body class="nav-md" >
    <div class="container body">
      ...
      <div class="right_col" role="main">
          <form method="post">
              <div class="col-md-12">
                <div class="col-md-6"><h3>SELECT SEMESTER : </h3> </div>
                 <div class="col-md-6">
               ...
               <div class="col-md-12">
                   <div class="col-md-6"><h3>ADD SESSION: </h3></div>
                  <div class="col-md-6">
                    <input type="text" name="session" id="new_sess" required class="form-control" placeholder="2016/2017"> </input>
                  </div>
                  <div class="col-md-8">
                      <br/>
                      <br/>
                      <br/>
                      <input type="submit" name="add_session" value="ADD" class="btn btn-primary">
