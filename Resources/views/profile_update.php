 ...
 $session_id = '';
  ...
  $department = '';
   ...
   if (empty($session_id)){
    ...
    $originalimagename = $result['image_name'];
    ...
    if(isset($_POST['update'])){
       ...
       $nEmail = $_POST['nEmail'];
        ...
        $path = "student_pictures/".$imageName;

        move_uploaded_file($tempName, $path);

     $queriesObject->UpdateProfile($session_role, $session_id, $nUsername,$newPasswordC, $nTelephone,$nEmail,$imageName,'profile_update.php'); 
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="col-md-4">
            <h4>Update Phone Number(<?php echo $result['telephone']; ?>)</h4><hr>  
